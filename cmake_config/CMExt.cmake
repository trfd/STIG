...
MACRO(cmext_add_module _name)
	...
	IF(EXISTS ${${_name}_MODULE_FILE})
		...
		FOREACH(_target ${${_name}_TARGETS})
			...
			SET_PROPERTY(TARGET ${_target} PROPERTY INCLUDE_DIRECTORIES ${INCLUDE_DIRS})

			#SET_PROPERTY(TARGET ${_target} PROPERTY RUNTIME_OUTPUT_DIRECTORY         ${BIN_DIR})
			#SET_PROPERTY(TARGET ${_target} PROPERTY RUNTIME_OUTPUT_DIRECTORY_DEBUG   ${BIN_DIR})
			#SET_PROPERTY(TARGET ${_target} PROPERTY RUNTIME_OUTPUT_DIRECTORY_RELEASE ${BIN_DIR})
			#SET_PROPERTY(TARGET ${_target} PROPERTY LIBRARY_OUTPUT_DIRECTORY 		 ${LIB_DIR})
			#SET_PROPERTY(TARGET ${_target} PROPERTY LIBRARY_OUTPUT_DIRECTORY_DEBUG   ${LIB_DIR})
			#SET_PROPERTY(TARGET ${_target} PROPERTY LIBRARY_OUTPUT_DIRECTORY_RELEASE ${LIB_DIR})
...
MACRO(cmext_add_library _module _name _libType)
	...
	SET_TARGET_PROPERTIES(${_name} PROPERTIES ARCHIVE_OUTPUT_DIRECTORY         ${LIB_DIR})
	SET_TARGET_PROPERTIES(${_name} PROPERTIES ARCHIVE_OUTPUT_DIRECTORY_DEBUG   ${LIB_DIR})
	SET_TARGET_PROPERTIES(${_name} PROPERTIES ARCHIVE_OUTPUT_DIRECTORY_RELEASE ${LIB_DIR})
